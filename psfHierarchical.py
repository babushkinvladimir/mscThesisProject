""" Implementation of patterns sequence forecasting algorithm with hierarchical
...
def psfHierarchical(dataset, numClusters, windowSize, outliersArray):
    w = windowSize
    # cluster the data and get labels
    labels = AgglomerativeClustering(n_clusters=numClusters, affinity='euclidean', linkage='ward').fit_predict(dataset)
