""" Implementation of patterns sequence forecasting algorithm with knn
...
def psfKmeans(dataset, numClusters, windowSize,outliersArray):
    w = windowSize
    # cluster the data
    knn = KMeans(n_clusters=numClusters, random_state=0).fit(dataset)
