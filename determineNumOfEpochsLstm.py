""" seraching for the optimal number of epochs for LSTM
...
if isPrice:
    resultsDirectory = directory + "/results/epochsLstmPrice" + region + "/"
else:
    resultsDirectory = directory + "/results/epochsLstmLoad" + region + "/"
...
rmse = history_dict['rmse_ud']
val_rmse = history_dict['val_rmse_ud']
...
plt.figure()
plt.plot(epochs, rmse[:len(epochs)], 'b', label='Training rmse')
plt.plot(epochs, val_rmse[:len(epochs)], 'r', label='Validation rmse')
...
ud_mape = np.load(resultsDirectory + "/ud_mapeNorm.npy")
val_ud_mape = np.load(resultsDirectory + "/val_ud_mapeNorm.npy")

np.save(resultsDirectory + "/maeNorm", mae)
np.save(resultsDirectory + "/val_maeNorm", val_mae)

np.save(resultsDirectory + "/mapeNorm", mape)
np.save(resultsDirectory + "/val_mapeNorm", val_mape)

np.save(resultsDirectory + "/rmseNorm", rmse)
np.save(resultsDirectory + "/val_rmseNorm", val_rmse)

np.save(resultsDirectory + "/mseNorm", mse)
np.save(resultsDirectory + "/val_mseNorm", val_mse)
...
numLayers1 = list(range(100, 1600, 100))
numLayers2 = list(range(100, 1600, 100))
for i in range(15):
    for j in range(15):
        print('processing layer1 ' + str(i) + ' layer2 ' + str(j))
        model = Sequential()
        model.add(LSTM(numLayers1[i], activation='relu', return_sequences=True, input_shape=(n_steps_in, n_features)))
        model.add(LSTM(numLayers2[j], activation='relu'))
        model.add(Dense(n_features))
        model.compile(optimizer='adam', loss='mse',
                      metrics=['mse', 'mae', 'mape', 'acc', rmse_ud, mre_ud, mae_ud, mape_ud])
        # fit model
        history = model.fit(partial_x_train, partial_y_train, epochs=100, verbose=0, validation_data=(x_val, y_val))
        history_dict = history.history
        ...
        del (model)
np.save(resultsDirectory + "/measuresArrayVal_epochs_100", measuresArrayVal)
np.save(resultsDirectory + "/measuresArrayTrain_epochs_100", measuresArrayTrain)
########################################################################################################################
measuresArrayVal = np.load(resultsDirectory + "/measuresArrayVal_epochs_100.npy")
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Mean absolute error (100 epochs)', fontsize=24, pad=20)
...
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgMaeLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Mean relative error (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Mean absolute percentage error (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
cbar.ax.set_yticklabels(ticklabs, fontsize=14)
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgMapeLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Root mean square error (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
cbar.ax.set_yticklabels(ticklabs, fontsize=14)
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgRmseLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Mean square error (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
cbar.ax.set_yticklabels(ticklabs, fontsize=14)
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgMseLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Accuracy (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
cbar.ax.set_yticklabels(ticklabs, fontsize=14)
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgAccLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
...
plt.xlabel('Number of LSTM units in Layer 2', fontsize=18, labelpad=10)
plt.ylabel('Number of LSTM units in Layer 1', fontsize=18, labelpad=10)
plt.title('Loss (100 epochs)', fontsize=24, pad=20)
divider = make_axes_locatable(pltAx)
cax = divider.append_axes("right", size="3%", pad=0.2)
cbar = plt.colorbar(color_map, cax=cax)
ticklabs = cbar.ax.get_yticklabels()
cbar.ax.set_yticklabels(ticklabs, fontsize=14)
cbar = plt.colorbar(color_map, cax=cax)
plt.savefig(resultsDirectory + "/avgLossLstm.pdf",
            bbox_inches='tight',
            transparent=True,
            pad_inches=0)
