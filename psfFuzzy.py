...
def psfFuzzy(dataset, numClusters, windowSize, outliersArray):
    w = windowSize
    # cluster the data
    # Initialization and training

    cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(np.transpose(dataset), numClusters, 2, error=0.005, maxiter=1000,
                                                     init=None)
